...
backdrop-blur-2xl  text-gray-300 border-2
border-gray-600 flex items-center justify-between max-sm:flex-col-reverse
rounded-1g'>
  <form onSubmit={hanldleSubmit} className="flex flex-col gap-5 p-10 flex-1">
...
to-violet-600 text-white p-2 rounded-full text-lg cursor-pointer">Save</button>
  ...
  <img src={authUser?.profilePic  || assets.logo_icon} className={`max-w-44 aspect-square rounded-full mx-10 max-sm:st-10 
